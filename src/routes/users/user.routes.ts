...
routes.get("/users", authUser, userExistVerifyMiddleware, listUserController)
...
routes.patch("/users/update", authUser, userExistVerifyMiddleware, newPasswordController)
